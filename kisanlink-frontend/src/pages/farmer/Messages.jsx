    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
          <h3 className="text-sm font-medium text-green-800 mb-2">How messaging works:</h3>
          <ul className="text-sm text-green-600 space-y-1">
            <li>• Click any conversation to chat with the customer</li>
            <li>• Customers can message you from your product listings</li>
            <li>• You can also start conversations from order notifications</li>
            <li>• Refresh to see new messages</li>
          </ul>
        </div>
      </div>
    </div>
