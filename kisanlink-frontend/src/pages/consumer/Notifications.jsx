          ...
          <div className="space-y-3">
            {filteredNotifications.map((notif, index) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border cursor-pointer transform transition-all duration-200 hover:shadow-md hover:scale-[1.005] hover:translate-x-1 overflow-hidden ${
                  !notif.is_read ? 'border-l-4 border-l-green-500' : 'border-gray-200'
                }`}
              >
