// src/components/ChatBox.jsx - Fixed with non-scrolling header
import React, { useState, useEffect, useRef, useCallback } from "react";
import { API_BASE_URL } from "../config";

const ChatBox = ({ otherId, farmerName }) => {
    ...
    >
      ...
      <div className="flex flex-col flex-shrink-0">
        {/* Chat Header - Stays visible */}
          ...
          <div className="bg-green-600 text-white  flex items-center ">
          
          </div>
        

        {/* File Preview (also stays in header area) */}
        {filePreview && (
      ...
      {/* Drag & Drop Overlay */}
      {isDragging && (
        <div className="absolute inset-0 bg-green-500 bg-opacity-20 z-20 flex items-center justify-center border-2 border-dashed border-green-500 rounded-lg m-2">
          <div className="text-center p-8 bg-white bg-opacity-90 rounded-lg shadow-lg">
            <div className="text-4xl mb-4">📎</div>
            <p className="text-lg font-semibold text-green-700">Drop file here to upload</p>
            <p className="text-sm text-gray-600 mt-2">Maximum file size: 10MB</p>
          </div>
        </div>
      )}

      {/* FIXED: Only messages area scrolls */}
          ...
          {messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-gray-600 max-w-sm mb-4">
                Start your conversation with {farmerName || `Farmer ${otherId}`}
              </p>
        ...
        <div className="flex space-x-2">
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              placeholder={`Type your message to ${farmerName || `Farmer ${otherId}`}...`}
              rows="1"
